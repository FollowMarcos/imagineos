...
export function TapNavigation() {
    ...
    return (
        <TooltipProvider delayDuration={0}>
            ...
            <aside className="fixed right-6 top-1/2 -translate-y-1/2 z-40 hidden lg:flex flex-col items-center gap-6 py-6 px-3 bg-background/60 backdrop-blur-xl border border-border/50 rounded-full shadow-2xl shadow-primary/5 ring-1 ring-white/10 transition-all duration-500 hover:bg-background/80">
